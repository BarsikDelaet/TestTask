...
from PageObject.Page.home_suggest import HomeSuggest
...
class TestTensor(unittest.TestCase):
    ...
    def test_01(self):
        ...
        suggest = HomeSuggest(driver)#Проверка на открытие suggest
        suggest.check_suggest()
        sleep(0.5)
    ...
    def test_02(self):
        ...
        sleep(2)
        next_window = WebDriver(driver)#Преключаемся на открывшееся окно
        ...
        open_img = OpenImg(driver)#Переключение фотографий и проверка на исполнителность
        open_img.work_img()
        sleep(2)
